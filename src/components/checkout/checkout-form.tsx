  ...
  const onSubmit = async (data: CheckoutFormValues) => {
    ...
    try {
      const orderData = {
        ...
        // include product details from URL
        productId: searchParams.get('productId'),
        framePrice: parseFloat(searchParams.get('framePrice') || '0'),
        lensPrice: parseFloat(searchParams.get('lensPrice') || '0'),
        shippingFee: shippingFee,
        lensSelection: searchParams.get('lensSelection'),
      };
